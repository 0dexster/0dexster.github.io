...
import { MapPin, Bed, Bath, Square, Search, SlidersHorizontal, ArrowLeft } from "lucide-react";
...
const PropertiesSale = () => {
  ...
  const properties = [
    ...
    },
    {
      ...
      area: 180,
      badge: "NOWE",
      description: "Odnowiona kamienica z zachowanymi historycznymi elementami. Własny ogród, garaż, eleganckie wnętrza."
    },
    {
      id: 4,
      title: "Loft Zabłocie",
    ...
    },
    {
      ...
      area: 250,
      badge: "EKSKLUZYWNE",
      description: "Luksusowa willa z ogrodem i basenem. Domofon, monitoring, garaż na 3 samochody, sauna."
    },
    {
      id: 7,
    ...
    },
    {
      ...
      area: 165,
      badge: "PREMIUM",
      description: "Wyjątkowy penthouse z tarasem dachowym. Widok na Wawel, klimatyzacja, underfloor heating."
    }
  ];
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-luxury-gray max-w-2xl mx-auto">
                Znajdź wymarzoną nieruchomość wśród naszej ekskluzywnej oferty mieszkań i domów na sprzedaż w Krakowie.
              </p>
            </div>
